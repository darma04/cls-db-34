...
class PengaturanPerusahaan(models.Model):
    ...
    nama_perusahaan = models.CharField(max_length=200, default='Central License Server', verbose_name="Nama Perusahaan")
    ...
    # System Settings
    system_title = models.CharField(max_length=200, blank=True, default='Central License Server', verbose_name="Judul Sistem")
...
class TemplateCetak(models.Model):
    ...
    header_nama_perusahaan = models.CharField(max_length=200, default="Central License Server", verbose_name="Nama Perusahaan")
    ...
    footer_copyright = models.CharField(max_length=300, default="© 2026 Central License Server", blank=True, verbose_name="Footer Copyright")
    ...
    def _get_default_values(cls, jenis):
        ...
        defaults_map = {
            ...
            'export_excel': {
                ...
                'footer_ucapan': '',
                'footer_keterangan': 'Diekspor dari Central License Server.',
                'footer_copyright': '© 2026 Central License Server',
            },
            'export_pdf': {
        ...
        base_defaults = {
            'header_nama_perusahaan': 'Central License Server',
