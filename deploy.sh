#!/bin/bash
# ===================================================================
# DEPLOYMENT SCRIPT - Central-License-Server-Isolated-Database-36
# ===================================================================
...
echo "=========================================="
echo "  Deploying: Central-License-Server-Isolated-Database-36"
...
if command -v systemctl &> /dev/null; then
    sudo systemctl restart gunicorn_Central-License-Server || echo "systemctl not configured yet"
elif command -v supervisorctl &> /dev/null; then
    sudo supervisorctl restart Central-License-Server || echo "supervisorctl not configured yet"
else
